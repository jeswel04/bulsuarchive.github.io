...
<div class="container">
  ...
  <h1>Update</h1>
    <div class="cardContainer" style="margin-top: 10px;">
        ...
        <?php
            if(!empty($user['0']['picture'])){

                echo "<h3>".$user['0']['picture']."-".$user['0']['lastname']."</h3>
                <iframe id= \"iframe\" name= \"iframe\" src=\"../upload_files/".$user['0']['picture']."toolbar=0\" frameborder=\"0\"></iframe>";
            }
            else
            echo "<h1>No picture</h1>";
        ?>
        </div>
        <form method="POST">
            ...
            <h3>School Id</h3>
            <input class="field" type="number" id="school_id" name="school_id" value="<?=$user['0']['school_id'];?>"></input>
            <div class="grid3">
                <div class="">
                    <h3>User Type</h3>
                    <select name="role_id" id="role_id" type="text">
                        <option value="<?=$user['0']['role_id'];?>" selected="selected"><?=print_r($user['0']['role_id']);?></option>
                ...
                <div class="">
                    ...
                    <select type="text" id="department_id" name="department_id" type="text">
                        <option value="<?=$user['0']['department_id'];?>"><?=$user['0']['department_id'];?></option>
                    </select>
                </div>
                <div class="">
                    <h3>Date Sign Up</h3>
                    <input class="field" type="date" value="<?=$user['0']['date_validate'];?>">
                </div>
            </div>
            <h3>Course</h3>
            <select id="course_id" name="course_id" type="text">
                <option value="<?=$user['0']['course_id'];?>" selected="selected"> <?=$user['0']['course_id'];?> </option>
                <option value="3">Faculty</option>
                <option value="2">Student</option>
            </select>
            <h3>Last name</h3>
            <input class="field" type="text" id="lastname" name="lastname" value="<?=$user['0']['lastname'];?>">
            <h3>First name</h3>
            <input class="field" type="text" id="firstname" name="firstname" value="<?=$user['0']['firstname'];?>">
            <h3>BULSU email</h3>
            <input class="field" type="text" id="email_verified" name="email_verified" value="<?=$user['0']['email_verified'];?>">
            <button type="submit" id="update" name="update" class="field_btn">Accept</button>
            <button type="submit" id="decline" class="field_btn_list" name="decline">Delete</button>
        <?endforeach;?>
        </form>
    </div>
