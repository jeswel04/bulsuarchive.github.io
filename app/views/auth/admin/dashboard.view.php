...
<div class="container">
  ...
  <main>
    ...
    <button>Overall Statistics</button>

    <div class="insights">
      <div>
      <label>Uploads</label><br>
      <?php $uploads = new Research;
              $temp = $uploads->rowCount();
        if($temp !=0){
      ...
      <div>
        ...
        <?php
          ...
          $count = $counter->sum('downloads');
          if(!empty($count)){
            echo"<span class = \"notif\">".$count[0]['sum']."</span>";
          }
        ?>
      </div> 
      <div>
...
<!-- ========== CHART ==========  -->    
    <h2 class="chart-header">Repository Analytics</h2>
    <div class="charts">
      <div class="card">
        <canvas id="departmentChart"></canvas>
        <div id="department-list" class="legend-container"></div>
      </div>
      <div class="card">
        <canvas id="gateChart"></canvas>
        <div id="gate-list" class="legend-container"></div>
      </div>
      <div class="card">
        <canvas id="bamChart"></canvas>
        <div id="bam-list" class="legend-container"></div>
      </div>
      <div class="card">
        <canvas id="iitChart"></canvas>
        <div id="iit-list" class="legend-container"></div>
      </div>
