  ...
  <main>
    ...
    <?php
        ...
        if($token != $research[0]['token']){
          ...
          if($history->where(['token'=>$research[$key]['token']])){
          ...
          echo
              ...
              "<a href=\"".$root."/download?file=".$research[$key]['picture']."\" class=\"btn_download\" style=\"background-color:var(--color-warning);\">Download Abstract</a>".
