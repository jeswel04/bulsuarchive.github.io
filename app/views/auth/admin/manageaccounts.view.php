      ...
      if(!empty(isset($_POST['search']))){
        if(!empty($search)){
            foreach($search as $keys=>$value){
              ...
              "<h2 style=\"color:var(--color-primary);\">".$search[$keys]['school_id']."</h2>".
              "<span>".$search[$keys]['lastname'].", ".$search[$keys]['lastname']."</span>".
              "<br><span>".$search[$keys]['email_verified']."</span>".
              "<br><p>".$search[$keys]['department_id']."</p>".
              "<span>".$search[$keys]['course_id']."</span>".
...
<div class="recent-order">
      <table>
        ...
        <?php
          $root = ROOT;
          foreach($user as $key=>$title){
            echo"<tr>".
                "<td>".$user[$key]['school_id']."</td>".
                "<td>".$user[$key]['lastname']."</td>".
                "<td>".$user[$key]['firstname']."</td>".
                "<td>".$user[$key]['email_verified']."</td>".
                "<td>".$user[$key]['department_id']."</td>".
                "<td>".$user[$key]['course_id']."</td>".
                "<td>".$user[$key]['role_id']."</td>".
                "<td>".$user[$key]['picture']."</a></td>".
                "<td>".$user[$key]['date_validate']."</td>".
                "<td> <a href=\"".$root."/manage?id=".$user[$key]['token']."\">"."View"."</td>".
                "</tr>";
            }
        ?>
        </tbody>
