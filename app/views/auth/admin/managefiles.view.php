        ...
        <?php
          ...
          foreach($research as $key=>$name){
            echo
                ...
                "<tr>".
                "<td>".$research[$key]['title']."</td>".
                "<td>".$research[$key]['type']."</td>".
                "<td>".$research[$key]['department_id']."</td>".
                "<td>".$research[$key]['course_id']."</td>".
                "<td>".$research[$key]['adviser']."</td>".
                "<td>".$research[$key]['date_research']."</td>".
                "<td> <a href=\"".$root."/editfile?id=".$research[$key]['token']."\">"."View"."</td>".
                "</tr>";
            }
          }
        ?>
